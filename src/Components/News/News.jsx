  ...
  return (
    ...
    <div className="alamin-news bg-[#F1E6DA] w-full">
        ...
        <div className="container">
            ...
            <div className="news-row flex  justify-between">
                <div className="single-card">
                    <img className='w-[410px]' src={card1} alt="card-img" />
                    <div className="card-text bg-[#F1E6DA] w-[410px] rounded-b-[24px] pl-[24px]">
                    ...
                    <p className=' text-[16px] font-dm text-[#744F40] font-medium pt-[15px] pb-[230px] w-[360px]' >Voluptatem eveniet voluptates. Doloremque ut
                ...
                {/* card-2 */}
                <div className="single-card">
                    <img className='w-[410px]' src={card2} alt="card-img" />
                    <div className="card-text bg-[#F1E6DA] w-[410px] rounded-b-[24px] pl-[24px]">
                    <div className="flex gap-[10px] items-center pt-[24px] ">
                        <h2 className='text-[16px] font-medium font-dm text-[#744F40]'>March 18, 2024</h2>
                        <img className='w-[9px]' src={newsdot} alt="news-dot" />
                    ...
                    <p className=' text-[16px] font-dm text-[#744F40] font-medium pt-[15px] pb-[255px] w-[360px]' >Maxime aut qui voluptatum et quo dolores ut
                ...
                {/* card 3 */}
                <div className="single-card">
                    <img className='w-[410px]' src={card3} alt="card-img" />
                    <div className="card-text bg-[#F1E6DA] w-[410px] rounded-b-[24px] pl-[24px]">
                    <div className="flex gap-[10px] items-center pt-[24px] ">
                        <h2 className='text-[16px] font-medium font-dm text-[#744F40]'>March 18, 2024</h2>
                        <img className='w-[9px]' src={newsdot} alt="news-dot" />
                    ...
                    <p className=' text-[16px] font-dm text-[#744F40] font-medium pt-[15px] pb-[224px] w-[360px]' >Sint voluptas et sed impedit atque eum. Facere
